...
- **配点（カテゴリ合計100）**：基本情報25 / コンテンツ20 / 写真15 / クチコミ25 / 投稿15
- **条件付き除外**：ウェブサイト=なし のとき HTTPS は評価対象外（二重減点しない）
- **サイテーション廃止**：NAP一致度→基本情報へ移動、掲載媒体・SNS活用・英語ビジネス名は削除

## 1. 項目一覧表

| カテゴリ | 項目 | タイプ | しきい値（段階1→5） | 重み |
|---|---|---|---|---|
| 基本情報(25) | オーナー登録 | toggle | なし=0 / あり=満点 | 2.0 |
| | 店舗名 | toggle | 実店舗表記と一致 | 1.0 |
| | 住所 | toggle | 正確 | 1.0 |
| | 電話番号 | toggle | 記載あり | 1.0 |
| | 営業時間 | toggle | 最新に更新 | 1.0 |
| | ウェブサイト | toggle | URL登録あり | 1.0 |
| | HTTPS対応 | toggle | HTTPS対応（サイト無し=対象外） | 1.0 |
| | NAP一致度 | toggle | 他媒体と店名/住所/電話が一致 | 1.5 |
| コンテンツ(20) | 説明文（文字数） | numeric(貼付) | 0 / 1〜249 / 250〜499 / 500〜649 / 650〜(上限750) | 2.0 |
| | 説明文（英語） | toggle | 英語を含む | 0.5 |
| | ロゴ | toggle | 設定あり | 0.8 |
| | メインカテゴリ | toggle | 正確 | 1.5 |
| | サブカテゴリ | toggle | 設定あり | 1.0 |
| | 特徴・属性 | toggle | 設定あり | 0.8 |
| 写真(15) | 写真の枚数 | numeric | 0 / 1〜5 / 6〜19 / 20〜49 / 50〜 | 1.0 |
| | オーナー投稿枚数 | numeric | 0 / 1〜4 / 5〜9 / 10〜19 / 20〜 | 1.0 |
| | 最新写真 | stage5 | なし / 1年〜 / 半年〜1年 / 1〜6ヶ月 / 1ヶ月以内 | 1.0 |
| クチコミ(25) | 評価点数 | numeric | <3.0 / 3.0〜3.4 / 3.5〜3.9 / 4.0〜4.4 / 4.5〜 | 1.2 |
| | クチコミ数 | numeric | 0〜5 / 6〜10 / 11〜30 / 31〜100 / 101〜 | 1.0 |
| | 返信率（直近10件） | numeric | 0 / 1〜2 / 3〜5 / 6〜8 / 9〜10 件 | 1.0 |
| | 最新のクチコミ | stage5 | なし / 1年〜 / 半年〜1年 / 1〜6ヶ月 / 1ヶ月以内 | 0.8 |
| | Q&A対応 | toggle | 回答あり | 0.6 |
| 投稿(15) | 投稿頻度（直近30日） | stage5 | 履歴なし / 0件 / 1〜3 / 4〜7 / 8〜 件 | 1.0 |

※写真の枚数しきい値（基準ライン=段階4）は暫定値。業種別データが揃い次第、差し替え可能な設計（`stages[].min` を変更するだけ）。
